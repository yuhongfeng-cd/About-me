# 嗨👋
 ...
 📫 我是俞鸿烽，目前对**数据分析、数据开发**比较感兴趣，可以通过邮箱联系我：**yuhf2000@163.com**

 👨‍💻 以下是我的个人主要经历！
 
<h3 align="left">字节跳动的实习经历:</h3>
<h4 align="left">工作职责:</h4>

- TikTok电商广告&搜索广告业务数据科学工作，包括日常数据统计分析、A/B实验分析、数据异动归因、数据洞察与机会发现
<h4 align="left">主要产出:</h4>

- **2025.11-2026.1**
  - Toko店铺卡SSR问题治理
    
  - ROI2 Automation实验搜索表现
...
<h3 align="left">快手的实习经历:</h3>
<h4 align="left">工作职责:</h4>

- 快手商业化内循环广告投放的数据分析工作，包括数据报表制作、目标追踪复盘、消耗异动归因、活动专项支持
...
证书：CET6、计算机三级(数据库)、计算机二级(office)、C1驾照

竞赛：在学校主要参加了华为杯、阿里天池、泰迪杯、高教社杯等竞赛，涵盖数据分析、数据挖掘、机器学习、数学建模等方向，均有国家级奖项

- [“华为杯”中国研究生数学建模竞赛(全国二等奖)](https://github.com/yuhongfeng-cd/Huawei-Cup)
  
- [“泰迪杯”数据分析职业技能大赛(全国一等奖)](https://github.com/yuhongfeng-cd/Taidi-Cup)
  
- [“阿里天池”太阳风暴识别和预警挑战赛(全国TOP3)](https://github.com/yuhongfeng-cd/Tianchi-Cup)
