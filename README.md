# 嗨👋
 ...
 📫 我是俞鸿烽，目前对**数据分析、数据科学**比较感兴趣，正在学习**数据仓库、AI**的相关知识，可以通过邮箱联系我：**yuhf2000@163.com**
...
- TikTok电商广告业务数据科学工作，包括日常数据统计分析、A/B实验分析、数据异动归因、数据洞察与机会发现
...
- “华为杯”中国研究生数学建模竞赛全国二等奖
- “泰迪杯”数据分析职业技能大赛全国一等奖
- “阿里云天池”太阳风暴识别和预警挑战赛全国TOP3
